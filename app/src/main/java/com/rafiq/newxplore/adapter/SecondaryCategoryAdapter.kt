...
class SecondaryCategoryAdapter(val userList: MutableList<Category>): RecyclerView.Adapter<SecondaryCategoryAdapter.ViewHolder>() {
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(View.OnClickListener {
            val intent = Intent(holder.tv_title.context, MainActivity::class.java)
